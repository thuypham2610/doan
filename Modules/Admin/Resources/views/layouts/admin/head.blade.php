<head>
    ...
    <link rel="stylesheet" href="{{Module::asset('admin:plugins/tempusdominus-bootstrap-4/css/tempusdominus-bootstrap-4.min.css')}}">
    <!-- iCheck -->
    ...
    <link rel="stylesheet" href="{{Module::asset('admin:dist/css/admin.css')}}">
    <!-- overlayScrollbars -->
