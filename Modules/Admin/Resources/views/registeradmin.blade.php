            ...
            <div class="card card-info">
                ...
                <!-- form start -->
                    <form class="form-horizontal" enctype="multipart/form-data" method="POST"
                          action="{{route('updateadmin',['id'=> $user['id']])}}">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-sm-10">
                                    <input type="text" id="inputPassword3" placeholder="thuy123"
                                           class="form-control input_width" name="username" value="{{$user['username']}}">
                                </div>
                            </div>
                            <div class="form-group row">
                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-3 col-sm-10 ">
                                    <input type="tel" id="inputPassword3" placeholder="0357783399"
                                           class="form-control input_width" name="phone" value="{{$user['phone']}}">
                                </div>
                            </div>
                            <div class="form-group row">
